...
export default function PixelCard({
  ...
  return (
    <div
      ref={containerRef}
      className={`h-[400px] w-[300px] relative overflow-hidden grid place-items-center aspect-[4/5] bg-card text-card-foreground border border-border rounded-2xl isolate select-none shadow-sm transition-all duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] hover:shadow-xl hover:z-10 hover:scale-[1.02] hover:-translate-y-0.5 active:scale-[0.99] ${className}`}
      {...rest}
